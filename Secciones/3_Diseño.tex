...
Para la conexion de la LCD1602, esta cuenta con un modulo I2C, por lo que solo se utilizaran 4 pines del Arduino Uno, siendo estos el $\SI{5}{\volt}$, \texttt{GND} y los pines \texttt{A4}
